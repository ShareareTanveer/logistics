  ...
  return (
    <section className="py-20 text-black">
      <div className="mx-auto px-6 text-center">
        <h2 className="text-4xl md:text-3xl font-extrabold mb-8 text-black">
          About Us
        </h2>
          ...
          <div className="flex justify-center gap-40 md:gap-20 flex-wrap mt-48">
            ...
            <div className="relative bg-white shadow-xl rounded-xl py-8 px-8 w-96 transform hover:scale-105 hover:shadow-2xl transition-all duration-300 ease-in-out">
              ...
              <div className="pt-16 text-center">
                ...
                <p className="font-semibold mb-4">Managing Partner</p>
                <p className="text-gray-700">
                  Md Rabiul Mollah&apos;s leadership drives the growth and
            ...
            <div className="relative bg-white shadow-xl rounded-xl p-8 w-96 transform hover:scale-105 hover:shadow-2xl transition-all duration-300 ease-in-out">
              ...
              <div className="pt-16 text-center">
                ...
                <p className="text-gray-700">
                  Noman Hosen&apos;s expertise in the import and export industry
                  has been instrumental in shaping our business model. His
                  strategic vision helps Atlas expand its market presence globally.
                </p>
              </div>
            </div>
        ...
        <div className="w-[90%] bg-black text-white shadow-xl rounded-lg p-8 mx-auto mt-12">
